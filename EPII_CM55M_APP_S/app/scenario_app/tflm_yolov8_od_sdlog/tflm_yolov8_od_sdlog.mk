...
APPL_DEFINES += -DTFLM_YOLOV8_OD_SDLOG
APPL_DEFINES += -Daudvidpre_ret_pll400_timer1 -DIP_xdma
APPL_DEFINES += -DEVT_DATAPATH
APPL_DEFINES += -DEVT_I2CS_0_CMD -DEVT_I2CS_1_CMD

#APPL_DEFINES += -DUART_SEND_ALOGO_RESEULT  # disabled: conflicts with SD logging (blocks ~300ms/frame)
...
override LINKER_SCRIPT_FILE := $(SCENARIO_APP_ROOT)/$(APP_TYPE)/TFLM_yolov8_od_sdlog_S_only.ld
else#TOOLChain
override LINKER_SCRIPT_FILE := $(SCENARIO_APP_ROOT)/$(APP_TYPE)/TFLM_yolov8_od_sdlog_S_only.ld
endif
